...
map(
	"v",
	"<leader><leader>r",
	external.execute_visual_selection_as_lua,
	{ noremap = true, desc = "Execute Lua selection" }
)
...
map("n", "<leader>tk", terminal.open, { desc = "Terminal" })
...
map("n", "<leader>tj", terminal.vertical, { desc = "Terminal vertical" })
